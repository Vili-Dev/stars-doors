...
<main>
    <!-- Hero Section -->
    <section class="hero-section bg-dark text-white py-4" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);">
        <div class="container">
            <div class="row justify-content-center text-center">
                <div class="col-lg-8">
                    <h1 class="display-5 mb-2">
                        <i class="fas fa-rocket"></i> Recherche Intergalactique
                    </h1>
                    <p class="lead mb-0">Trouvez votre logement parfait parmi les étoiles</p>
                </div>
            </div>
        </div>
    </section>
